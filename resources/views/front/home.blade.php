        ...
        <div class="single-hero-slide" style="background-image: url('/upload/sliders/{{ $p->image }}')">
          <div class="slide-content h-100 d-flex align-items-center">
            <div class="slide-text">
              ...
              <p class="text-white" data-animation="fadeInUp" data-delay="400ms" data-duration="1000ms">{{ $p->description }}</p><a class="btn btn-primary" href="{{ $p->link }}" data-animation="fadeInUp" data-delay="800ms" data-duration="1000ms">Selengkapnya</a>
            </div>
          </div>
        </div>
        @endforeach
